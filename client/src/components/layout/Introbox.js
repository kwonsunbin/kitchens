            ...
            <Grid container item xs={10} className="introbox">
              ...
              <Grid item xs={12}>
                <p>
                  ...
                  담고있다. 토끼는 게으른 인간, 거북이는 성실한 인간을 상징한다.
                  초등학교 시간에 토론으로 자주 인용된다. 하지만 서양에 어떤
                  사람들은 반대로 거북이가 토끼를 보고도 그냥 뛰어갔기에
                  공정하지 않으므로 거북이가 더 나쁘다고 하는 경우도 있다.
                  그리고 비슷한 이야기로는 별주부전이 있다 토끼전에서도 거북이
                  대신 자라가 등장하면서 자라는 비록 마지막에는 꾀많은 토끼에게
                  속았으나 용왕님의 병이 걸려 토끼의 간을 구해 낫기 위해
                  육지까지 올라와 토끼를 데려오는 충성심이 나타낸다. 반면
                  거기서도 토끼는 자신의 죽음을 피하기 위해 용왕님을 속이고
                  자라에게도 화풀이를 하는 마치 나쁜 주인공처럼 등장한다. 즉,
                  토끼와 거북이 , 혹은 토끼와 자라 등이 등장할 경우 공통적으로
                  토끼가 어리석거나 나쁘다는 식처럼 보이게 된다. 반면 토끼에게
                  뒤떨어지기도 하는 거북이나 자라 등은 적어도 충성심이 있고
                  충성심을 알거나, 게으름없이 부지런하고 성실하는 주인공으로
                  등장하는 것이 같다.
                </p>
              </Grid>
            </Grid>
